...
var arr = [0x0,
    ...
    0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, "hide", "#myImgTemp", "#myCanvasImg",
...
$(arr[0x94])["click"](function () {
    ...
    html2canvas(document[arr[0x93]]("#saveImg"), {
        useCORS: true,
        ...
        let _0xa730x2b = _0xa730x24["toDataURL"]("image/png")["replace"]("image/png",
            arr[0x8b]);
        _saveImg["append"](arr[0x8c] + _0xa730x2b + arr[0x8d]);
        _saveImg["css"]({
            '\x7A\x2D\x69\x6E\x64\x65\x78': 999
        });
        _saveImg["append"](arr[0x8e]);
        _saveImg["append"](arr[0x8f]);
        $(arr[0x91])["click"](function () {
            _saveImg["css"]({
...
$(arr[0x96])["click"](function () {
    $("body")["toggleClass"](arr[0x95])
});;;
